...
2. Download the repository: [lemmings-io/02-alienmirror](https://github.com/lemmings-io/02-alienmirror/archive/master.zip)
...
2. Once logged in to the VM shell change into the alienmirror project directory
